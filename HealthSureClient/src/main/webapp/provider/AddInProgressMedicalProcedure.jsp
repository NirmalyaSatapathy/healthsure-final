...
<head>
  ...
  <script type="text/javascript">
    ...
    <style>
        ...
        /* brighter, bolder error messages */
.error-message {
...
<f:view>
    <div class="container">
        <h:form prependId="false">
            <h2>In-Progress Long-Term Medical Procedure</h2>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <h:outputLabel for="startDate">
                       <span style="color:red">*</span> Start Date (Today): 
                    </h:outputLabel>
                    <h:inputText id="startDate" value="#{procedureController.procedure.fromDate}" readonly="true">
