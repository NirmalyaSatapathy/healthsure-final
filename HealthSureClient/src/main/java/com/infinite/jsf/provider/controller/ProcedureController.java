...
public class ProcedureController {
        ...
        if (!medicalProcedure.getProvider().getProviderId().matches("^[Pp][Rr][Oo][Vv]\\d{3}$"))
 {
    ...
    public String prescriptionDetailsSubmit() {
    	 FacesContext context = FacesContext.getCurrentInstance();
    	 if((prescribedMedicines==null || prescribedMedicines.isEmpty() )&&(procedureTests==null || procedureTests.isEmpty()))
    	 {
    		 context.addMessage("submit", new FacesMessage(FacesMessage.SEVERITY_ERROR,
