...
public String toString() {
	return "PatientInsuranceDetails [subscribeId=" + subscribeId + ", hId=" + hId + ", patientName=" + patientName
			...
			+ ", coverageStartDate=" + coverageStartDate + ", coverageEndDate=" + coverageEndDate + ", coverageStatus="
			+ coverageStatus + ", coverageType=" + coverageType + ", coverageLimit=" + coverageLimit + ", remaining="
			+ remaining + ", claimed=" + claimed + ", lastClaimDate=" + lastClaimDate + ", subscribedMembers="
			+ subscribedMembers + "]";
}
...
public PatientInsuranceDetails(String subscribeId, String hId, String patientName, String companyName, String planName,
		Date enrollmentDate, Date coverageStartDate, Date coverageEndDate, SubscriptionStatus coverageStatus,
		SubscriptionType coverageType, double limit, double remaining, double claimed, Date lastClaimDate,
		List<SubscribedMember> subscribedMembers) {
	super();
	this.subscribeId = subscribeId;
	this.hId = hId;
	this.patientName = patientName;
